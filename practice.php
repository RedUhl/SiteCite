...
<!-- ?php include "CitationLogic/mutator.php"?>
?php include "CitationLogic/"?> -->
<?php
...
<body>
    ...
    <div id="page" class="d-flex mt-5 pt-3 page">
        ...
        <main class="content w-100">
            <div id="container" class="container">
                ...
                <!-- Hints -->
                <div id="hintOne" class="alert alert-success hintOne" role="alert">
                    <h4 class="alert-heading">Hint</h4>
                    <hr>
                    <p class="mb-0"></p>
                </div>
                <div id="hintTwo" class="alert alert-success hintTwo" role="alert">
                    <h4 class="alert-heading">Hint</h4>
                    <hr>
                    <p class="mb-0"></p>
                </div>
                <div id="hintThree" class="alert alert-success hintThree" role="alert">
                    <h4 class="alert-heading">Hint</h4>
                    <hr>
                    <p class="mb-0"></p>
                </div>
